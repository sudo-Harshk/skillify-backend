...
async function routes(fastify, options) {
  ...
  fastify.post('/questions/generate', async (request, reply) => {
    ...
    const prompt = `Generate 10 advanced-level multiple-choice questions (MCQs) for the chapter "${chapter}" in the subject of ${subject} for the ${examType} exam. These questions should be designed to test a deep understanding of the material, incorporating complex problem-solving and critical thinking skills suitable for high-stakes assessments. Each question must cover various intricate aspects of the chapter, and every question should have four options labeled (a), (b), (c), and (d), with one or more correct answers clearly indicated. Each question should also include a comprehensive explanation (2-3 lines) detailing the correct answer and the rationale behind it. 
    ...
    Ensure that each question adheres to the challenging nature expected in the ${examType} exam, emphasizing concepts, deep analytical skills, and sophisticated problem-solving strategies relevant to the given difficulty level, such as those found in JEE Advanced for high complexity and in-depth understanding.`;
    try {
